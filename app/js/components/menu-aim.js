function calculateTopLeftAndBottomRightCoordinates(element) {
  ...
  var topY = rect.top + (window.pageYOffset || document.documentElement.scrollTop);
  return {
...
function menuAim(menuElement, options) {
  ...
  var menuItemActiveClassName = options.menuItemActiveClassName || 'menu-aim__item--active';
  var menuItemSubMenuSelector = options.menuItemSubMenuSelector || '.menu-aim__item-submenu';
  ...
  var menuElementCoordinates = calculateTopLeftAndBottomRightCoordinates(menuElement);
  ...
  function activateMenuItem(menuItem) {
    ...
    var activeSubMenuCoordinates = calculateTopLeftAndBottomRightCoordinates(activeSubMenu);
...
const element = document.querySelector('.navigation__cate_items');
const options = {
  menuItemSelector: '.link-cls',
  menuItemActiveClassName: 'menu-aim__item--active',
  menuItemSubMenuSelector: '.sub_menu',
